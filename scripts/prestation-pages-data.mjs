    ...
    blocks: [
      ...
      },
      {
        ...
        notes: [
          ...
          { t: 'Ce qui reste à votre charge', d: "Le nom de domaine et l'hébergement, payés en direct et à votre nom. Comptez 15 € par an pour le domaine." },
        ],
    ...
    blocks: [
      ...
      },
      {
        ...
        notes: [
          ...
          { t: 'Les deux postes annexes', d: "Le nom de domaine, 15 € par an, et l'hébergement, de 0 à 15 € par mois. Vous les payez en direct, à votre nom, sans marge de ma part." },

...
Les présentes CGV s'appliquent à tout Client, qu'il agisse à titre **professionnel** (B2B) ou en qualité de **consommateur** au sens du Code de la consommation (B2C). Certaines stipulations spécifiques aux Clients consommateurs sont expressément identifiées comme telles. À défaut, les dispositions s'appliquent indistinctement aux deux catégories de Clients.
